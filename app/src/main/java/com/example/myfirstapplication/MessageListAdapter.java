...
//            txt_receivermsgtime.setText(messages.get(position).message);
        }
            ...
            public boolean onLongClick(View v) {
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        FirebaseDatabase.getInstance().getReference().child("message").child(userid).child(messages.get(position).id).setValue(null);
                        dialog.dismiss();
                    }
                });
