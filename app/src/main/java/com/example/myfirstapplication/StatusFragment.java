...
public class StatusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_status, container, true);
        ...
        //get data of status table and bind into array list
    ...
    // to get a images in Realtime database and storage
    @Override
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==10)
        {
            ...
            FirebaseStorage.getInstance().getReference().child("status").child(filename).putFile(data.getData()).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        @Override
                        public void onSuccess(Uri uri) {
                            //now the status uploading is successful, let's
                            //upload Status info into database
                            //get  name of user for realtime database on uid
